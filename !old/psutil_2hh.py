...
# IMPROVED RESPONSIVE PROGRESS BAR
def create_responsive_progress_bar(percentage: float, available_width: int = None,
    ...
    try:
        ...
        # Create a single string for the entire bar
        bar_str = '■' * filled + '·' * remainder
        
        # Create a single Text object from the combined string
        # This prevents internal truncation with ellipsis
        bar = Text(bar_str)
        
        # Set styles for the different parts of the bar
        bar.stylize(color, 0, filled)
        if remainder > 0:
            bar.stylize("bright_black", filled, filled + remainder)
...
class SelfMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("Resource", style="cyan", width=col_width, no_wrap=True)
            table.add_column("Usage", ratio=1)
            table.add_column("Details", style="bright_blue", ratio=1)
...
class MemoryMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        try:
            ...
            table.add_column("Memory", style="cyan", width=col_width, no_wrap=True)
            table.add_column("Usage", ratio=1)
            table.add_column("Details", style="bright_blue", ratio=1)
...
class NetworkMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("Network", style="cyan", width=col_width, no_wrap=True)
...
class DiskMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("Disk", style="cyan", width=col_width, no_wrap=True)
            table.add_column("Usage", ratio=1)
            table.add_column("Details", style="bright_blue", ratio=1)
...
class ServiceMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("Service", style="cyan", width=col_width, no_wrap=True)
...
class GPUMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("GPU", style="cyan", width=col_width, no_wrap=True)
            table.add_column("Usage", ratio=1)
            table.add_column("Details", style="bright_blue", ratio=1)
...
class FirewallMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("Firewall", style="cyan", width=col_width, no_wrap=True)
            table.add_column("Status", ratio=1)
            table.add_column("Details", style="bright_blue", ratio=1)
...
class SensorMonitor(BaseMonitor):
    ...
    def render(self):
        ...
        try:
            ...
            table.add_column("Sensor", style="cyan", width=col_width, no_wrap=True)
            table.add_column("Usage", ratio=1)
            table.add_column("Details", style="bright_blue", ratio=1)
...
class ProcessMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("PID", style="cyan", width=pid_width, no_wrap=True)
            table.add_column("Name", style="bright_blue", width=name_width, no_wrap=True)
            table.add_column("CPU%", justify="right", width=cpu_width, no_wrap=True)
            table.add_column("Memory", justify="right", width=mem_width, no_wrap=True)
...
class AlertMonitor(BaseMonitor):
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("Time", style="cyan", width=time_width, no_wrap=True)
            table.add_column("Category", style="bright_blue", width=category_width, no_wrap=True)
