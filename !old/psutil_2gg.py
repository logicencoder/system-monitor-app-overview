...
DEFAULT_CONFIG = {
    ...
    'ui': {
        'theme': 'dark',
        'left_column': ['self', 'cpu', 'gpu', 'process', 'services'],
        'right_column': ['memory', 'disk', 'network', 'sensors', 'battery', 'firewall'],
        'cores_per_line': 4
    },
    'alerts': {
        'enabled': True,
...
class ProcessMonitor(BaseMonitor):
    ...
    def __init__(self):
        try:
            ...
            self.processes_limit = config['monitors']['process']['limit']  # Get limit from config (now 20)
    ...
    def _get_processes(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Update cache
            self.process_cache = processes[:self.processes_limit]  # Limit to configured number (20)
    ...
    def render(self) -> Panel:
        ...
        try:
            ...
            table.add_column("Name", style="bright_blue", width=25)  # Wider to fit python script names
